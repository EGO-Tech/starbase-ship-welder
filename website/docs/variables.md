...
| `KT` | Target message for ISAN 3 in 1 | - | [Base (Back)](./constructing/back-section/), Base (Front) | N | Y | - | - |
...
| `PlasmaCharge` | Plasma thruster current charge level (Maximum of 1) | - | [Base (Back)](./constructing/back-section/) | Y | Y | - | - |
